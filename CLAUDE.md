...
`python -m coding update-sheets` brings existing sheets up to date when the schema changes (new trailing columns like Comments, or new elements added to the planar structure). Always dry-run first.
