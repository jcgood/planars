...
if __name__ == "__main__":
    ...
    print()
    print("No-free complete span:      ", fmt(result["no_free_complete_domain"]))
    print("No-free partial span:       ", fmt(result["no_free_partial_domain"]))
    print("Single-free complete span:  ", fmt(result["single_free_complete_domain"]))
    print("Single-free partial span:   ", fmt(result["single_free_partial_domain"]))
