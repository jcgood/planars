...
_QUALIFICATION_RULE_HASH = "fa856d1c"
...
def derive_play_language_domains(
    ...
    *,
    ...
    in ch. 8 (Chatino) — no complete language data section was reviewed. Diagnostic
    criterion design is speculative. Verify thoroughly before use.
    ...
    qualification: ALL elements have applies=y. Partial qualification: at
    least one element has applies=y.
