...
#   Rscript scripts/planarsviz_checks/check_spanchart.R results/chart_data/shifted_nyan shifted_nyan library-only
...
if (library_only) {
  nyan_pdf <- file.path("results", "nyan1308", folder, "nyan1308_spanchart.pdf")
