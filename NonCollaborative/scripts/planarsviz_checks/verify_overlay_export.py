...
For charts 7-9 (docs/PLAN_planarsviz_library.md): the archived
nyan1308_laminar_overlay.r (five coloured groups, thickness exponent 0.5,
alpha divisor 2) and nyan1308_all_families_labeled.r (one black "all" group,
exponent 0.75, divisor 1) -- see superseded.py. This
...
for script_name, exponent, divisor in CASES:
    text = superseded("results", script_name).read_text()
...
plain = superseded("results", "nyan1308_all_families_labeled.r").read_text().splitlines()
word = superseded("results", "nyan1308_all_families_labeled_wordhood.r").read_text().splitlines()
