...
# Pooled multi-class bundles, approximating a morphosyntax/phonology split --
# crude on purpose, see laminar_analysis.py's __main__ block for the same
# caveat. Colors match each bundle's own forest chart
# (nyan1308_{name}_laminar_forest.pdf, generated by laminar_analysis.main()).
# (name, subset of Domain_Type values, color, display label)
