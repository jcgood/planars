...
# results/laminar_spanchart.r, lines 1-35, at commit 43a308f (a generated
# script whose generator was never committed), wrapped in an uncalled
# function so loading the package doesn't run it. No other edits. Literals
# are replaced with bundle data in the next commit.

spanchart_step1_copy <- function() {
library(ggplot2)
