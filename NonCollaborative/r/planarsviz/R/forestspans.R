...
# results/nyan1308_forestspans_plot.r, lines 1-140, at commit 43a308f
# (written by scripts/make_forestspans_table.py make_r_plot_script()),
# wrapped in an uncalled function so loading the package doesn't run it.
# No other edits. results/nyan1308_forestspans_plot_no_tono.r is the same
# code with different data rows, count and file name, so it is not copied
# separately. Literals are replaced with bundle data in the next commit.

forestspans_step1_copy <- function() {
