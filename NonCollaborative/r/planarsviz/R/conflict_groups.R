...
# results/laminar_conflict_groups.r, lines 1-1684, at commit 43a308f (a
# generated script whose generator was never committed), wrapped in an
# uncalled function so loading the package doesn't run it. No other edits.
# Literals are replaced with bundle data in the next commit.

conflict_groups_step1_copy <- function() {
library(ape)
library(ggplot2)
library(ggtree)
library(patchwork)
