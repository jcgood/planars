...
- `PLAN_cross_language_charts.md` / `CROSS_LANGUAGE_PROGRESS.md` — charts and a summary table setting all 22 structures side by side, bearing on the three hypotheses. **`CROSS_LANGUAGE_PROGRESS.md` is the current state of that work.**
